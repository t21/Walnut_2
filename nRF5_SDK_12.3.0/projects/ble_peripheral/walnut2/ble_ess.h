...
typedef void (*ble_ess_evt_handler_t) (ble_ess_t * p_hrs, ble_ess_evt_t * p_evt);
...
typedef struct
{
    ...
    bool                         is_temperature_sensor_supported;
    ...
    ble_srv_cccd_security_mode_t ess_temperature_attr_md;
} ble_ess_init_t;
 ...
 *
 * @details Handles all events from the GATT module of interest to the Environmental Sensing Service.
 *
