...
#define I2C_DAT_PIN 13

#define BUTTON_1 17    /**< Button used to wake up the application. */
#define LED_1 21    /**< Button used to wake up the application. */

#define DEBUG_UART_RX_PIN 11    // Red
#define DEBUG_UART_TX_PIN 9    // Yellow, connected to USB->UART_RX
#define DEBUG_UART_RTS_PIN 10    // White
#define DEBUG_UART_CTS_PIN 8    // Black, connected to USB->UART_RTS

#define ALARM1_HALL_SENSOR_PIN 24
#define AMBIENT_LIGHT_EN_PIN 20
#define PIR_DETECT_PIN 3
#define MOISTURE_EN_PIN 0
#define VDD_BOOST_EN 30

#define ACCEL_INT1_PIN 5
#define ACCEL_INT2_PIN 4
#define GYRO_INT1_PIN 12
#define GYRO_INT2_PIN 14
#define MAG_DRDY_PIN 6
